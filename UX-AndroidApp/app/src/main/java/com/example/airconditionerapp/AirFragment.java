...
//        return inflater.inflate(R.layout.fragment_air, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        if(MainActivity.getHelp()) {
            Snackbar mySnackbar = Snackbar.make(view.findViewById(R.id.pop_up_message), R.string.air_pop_up, Snackbar.LENGTH_LONG);
        ...
        try{
            ...
            view.findViewById(R.id.BackButton).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    NavHostFragment.findNavController(AirFragment.this)
                            .navigate(R.id.action_AirFragment_to_ModesFragment);
                }
            });
            ...
            view.findViewById(R.id.submit_btn).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    NavHostFragment.findNavController(AirFragment.this)
                            .navigate(R.id.action_AirFragment_to_IntesityFragment);
                }
            });

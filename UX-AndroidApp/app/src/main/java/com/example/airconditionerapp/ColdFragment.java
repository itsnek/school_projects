...
public class ColdFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_cold, container, false);
        return view;
...
//        return inflater.inflate(R.layout.fragment_cold, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState){
        ...
        if(MainActivity.getHelp()) {
            Snackbar mySnackbar = Snackbar.make(view.findViewById(R.id.pop_up_message), R.string.cold_pop_up, Snackbar.LENGTH_LONG);
        ...
        try{
            ...
            view.findViewById(R.id.BackButton).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    NavHostFragment.findNavController(ColdFragment.this)
                            .navigate(R.id.action_ColdFragment_to_ModesFragment);
                }
            });
            ...
            view.findViewById(R.id.submit_btn).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    NavHostFragment.findNavController(ColdFragment.this)
                            .navigate(R.id.action_ColdFragment_to_IntesityFragment);
                }
            });

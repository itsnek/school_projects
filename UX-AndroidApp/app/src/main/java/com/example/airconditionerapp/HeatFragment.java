...
//        return inflater.inflate(R.layout.fragment_heat, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        if(MainActivity.getHelp()) {
            Snackbar mySnackbar = Snackbar.make(view.findViewById(R.id.pop_up_message), R.string.heat_pop_up, Snackbar.LENGTH_LONG);
        ...
        try{
            ...
            view.findViewById(R.id.BackButton).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    NavHostFragment.findNavController(HeatFragment.this)
                            .navigate(R.id.action_HeatFragment_to_ModesFragment);
                }
            });
            ...
            view.findViewById(R.id.submit_btn).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    NavHostFragment.findNavController(HeatFragment.this)
                            .navigate(R.id.action_HeatFragment_to_IntesityFragment);
                }
            });
